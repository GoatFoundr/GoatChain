...
contract GoatToken is ERC20, Ownable, Pausable, ReentrancyGuard {
    // Token metadata for wallet display
    string public constant TOKEN_LOGO = "https://goatfundr.com/assets/Transparent%20GoatChain%20Logo.png";
    string public constant TOKEN_WEBSITE = "https://goatfundr.com";
    string public constant TOKEN_DESCRIPTION = "GoatChain - The Premier Platform for Artist Tokenization";
    ...
    uint256 public constant MAX_PLATFORM_FEE = 400; // 4% max platform fee
    uint256 public constant MAX_ARTIST_FEE = 200; // 2% max artist fee
    ...
    event ArtistFeeCollected(address indexed from, uint256 amount);
