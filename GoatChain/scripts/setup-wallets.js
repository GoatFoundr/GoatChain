...
async function main() {
  ...
  const tokenMetadata = {
    ...
    symbol: "GOATCHAIN",
    decimals: 18,
    logo: "https://goatfundr.com/assets/Transparent%20GoatChain%20Logo.png",
    website: "https://goatfundr.com",
    description: "GoatChain - The Premier Platform for Artist Tokenization"
  };
  ...
  console.log("5. Logo URL: " + tokenMetadata.logo);
